...
5. u need two terminals to run this:
...
- first time u run it, transformers.js will download the embedding model to cache. it might hang for a sec but just let it finish.
